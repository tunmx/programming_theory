...
def urm_min(x, y, safety_count=10000):
    num_of_registers = haddr(min_instruct) + 1
    registers = allocate(num_of_registers)
    input_nodes = {1: x, 2: y}
    result = forward(input_nodes, registers, min_instruct, safety_count=safety_count)
